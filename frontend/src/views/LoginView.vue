...
const handleLogin = async (formData: LoginFormState) => {
  ...
  try {
    console.log('Logging into RP Corporate ERP:', formData)
            ...
            <div class="space-y-4">
              ...
              <div class="pt-1">
                <div class="grid grid-cols-4 gap-2 mb-2">
                  <div class="h-1 rounded-full transition-colors" :class="hasMinLength ? 'bg-blue-500' : 'bg-slate-200'"></div>
                  <div class="h-1 rounded-full transition-colors" :class="hasUppercase ? 'bg-blue-500' : 'bg-slate-200'"></div>
                  <div class="h-1 rounded-full transition-colors" :class="hasNumber ? 'bg-blue-500' : 'bg-slate-200'"></div>
                  <div class="h-1 rounded-full transition-colors" :class="hasSpecialChar ? 'bg-blue-500' : 'bg-slate-200'"></div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-y-1 gap-x-4 text-[11px]">
                  ...
                  <div class="flex items-center space-x-1.5" :class="hasSpecialChar ? 'text-blue-600' : 'text-slate-400'">
                    <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
